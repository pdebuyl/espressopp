...
This file also dumps the final coordinates in a HDF5 file.
...
print "writing pdb file ...", time.asctime()
filename = "lennard_jones_fluid_%0i.pdb" % integrator.step
espressopp.tools.pdbwrite(filename, system, molsize=Npart)
print "done pdb file ...", time.asctime()

print 'before h5py dump', time.asctime()
MyStore = espressopp.analysis.PyStore(system)
MyStore.open_file('lj_dump.h5')
MyStore.dump()
MyStore.close_file()
print 'after h5py dump', time.asctime()
